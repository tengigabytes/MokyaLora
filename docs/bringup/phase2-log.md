...
**Open issues carried forward:** P2-7 (Core 0 ISR stack overflow), P2-9 (first-boot HardFault on empty flash — may be mitigated by flash_safety_wrap.c's c1_ready==0 path but not yet verified).
